...
/* @@protoc_insertion_point(class_definition:github.nkibler7.osrswikiscraper.NpcInfo) */ {
 public:
 ...
 private:
  ...
  static ::absl::string_view FullMessageName() { return "github.nkibler7.osrswikiscraper.NpcInfo"; }
...
class NpcInfos final : public ::google::protobuf::Message
/* @@protoc_insertion_point(class_definition:github.nkibler7.osrswikiscraper.NpcInfos) */ {
 public:
  inline NpcInfos() : NpcInfos(nullptr) {}
  ~NpcInfos() override;
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR NpcInfos(
      ::google::protobuf::internal::ConstantInitialized);

  inline NpcInfos(const NpcInfos& from) : NpcInfos(nullptr, from) {}
  inline NpcInfos(NpcInfos&& from) noexcept
      : NpcInfos(nullptr, std::move(from)) {}
  ...
  friend void swap(NpcInfos& a, NpcInfos& b) { a.Swap(&b); }
  ...
  NpcInfos* New(::google::protobuf::Arena* arena = nullptr) const final {
    return ::google::protobuf::Message::DefaultConstruct<NpcInfos>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const NpcInfos& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom(const NpcInfos& from) { NpcInfos::MergeImpl(*this, from); }
 ...
 private:
  friend class ::google::protobuf::internal::AnyMetadata;
  static ::absl::string_view FullMessageName() { return "github.nkibler7.osrswikiscraper.NpcInfos"; }

 protected:
  explicit NpcInfos(::google::protobuf::Arena* arena);
  NpcInfos(::google::protobuf::Arena* arena, const NpcInfos& from);
  NpcInfos(::google::protobuf::Arena* arena, NpcInfos&& from) noexcept
      : NpcInfos(arena) {
    *this = ::std::move(from);
  }
  const ::google::protobuf::Message::ClassData* GetClassData() const final;
 ...
 public:
  ...
  ::google::protobuf::RepeatedPtrField<::github::nkibler7::osrswikiscraper::NpcInfo>* mutable_npcs();
  ...
  const ::google::protobuf::RepeatedPtrField<::github::nkibler7::osrswikiscraper::NpcInfo>& npcs() const;
