...
class StatBonuses final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:github.nkibler7.osrswikiscraper.StatBonuses) */ {
 public:
  inline StatBonuses() : StatBonuses(nullptr) {}
  ~StatBonuses() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR StatBonuses(::google::protobuf::internal::ConstantInitialized);

  inline StatBonuses(const StatBonuses& from)
      : StatBonuses(nullptr, from) {}
  StatBonuses(StatBonuses&& from) noexcept
    : StatBonuses() {
    *this = ::std::move(from);
  }
  ...
  friend void swap(StatBonuses& a, StatBonuses& b) {
    a.Swap(&b);
  }
  ...
  StatBonuses* New(::google::protobuf::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<StatBonuses>(arena);
  }
  using ::google::protobuf::Message::CopyFrom;
  void CopyFrom(const StatBonuses& from);
  using ::google::protobuf::Message::MergeFrom;
  void MergeFrom( const StatBonuses& from) {
    StatBonuses::MergeImpl(*this, from);
  }
  private:
  ...
  static ::absl::string_view FullMessageName() {
    return "github.nkibler7.osrswikiscraper.StatBonuses";
  }
  protected:
